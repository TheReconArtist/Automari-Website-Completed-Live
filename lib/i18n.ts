export const i18n = {
  en: {
    ...
    inbox: {
      ...
      toastAssignedTitle: "Email Assigned",
      toastAssignedDescription: (team: string) => `Email assigned to ${team}`,
      toastArchivedTitle: "Email Archived",
      toastArchivedDescription: "Email has been archived successfully.",
      toastSnoozedTitle: "Email Snoozed",
      toastSnoozedDescription: "Email will reappear later.",
      toastRefreshTitle: "Refreshing...",
      toastRefreshDescription: "Fetching new emails from your inbox.",
      toastRefreshedTitle: "Inbox Refreshed",
      toastRefreshedDescription: "Your inbox has been updated.",
